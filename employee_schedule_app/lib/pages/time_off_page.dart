...
class _TimeOffPageState extends State<TimeOffPage> with SingleTickerProviderStateMixin {
...
class _TimeOffRequestSheetState extends State<_TimeOffRequestSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // PTO/Sick require approval if 2+ entries already exist for that day
      bool requiresApproval = _selectedType.toLowerCase() == 'vac';
      ...
      child: Column(
        ...
        children: [
          ...
          SegmentedButton<String>(
            segments: const [
              ButtonSegment(value: 'pto', label: Text('PTO')),
              ButtonSegment(value: 'vac', label: Text('Vacation')),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    _selectedType.toLowerCase() == 'vac'
                        ? 'Vacation requests require manager approval'
                        : 'PTO/Sick requests are auto-approved unless 2+ requests already exist for that day',
                    style: TextStyle(
